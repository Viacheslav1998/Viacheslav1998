...
### 🧠 Немного обо мне:
- 🔭 Работа над пет проектами . очереди . WSL - docker/ проверка сложных систем. оптимизация запросов.   
- 🌱 Изучаю и работаю:  **TypeScript**, **React**, **C++**, **PostgreSQL**   
- 💬 Готов обсудить: Full/back-end разработку
- ⚡ Факты обо мне:  любимый стиль написания проектов - MVC, SOLID, DRY, OOP, KISS, чистый код, постоянно пишу и веду чистый документированный код, мало кто такой умеет,
наймешь меня не пожелеешь никогда  , не брезгую не *ИИ* не *темболее докой*.
Документация кода, понятные названия переменных, функций. 
---
